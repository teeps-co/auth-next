 ...
 * import { UserProvider } from '@teeps-co/teeps-auth-next';
 *
 ...
 * import { useUser } from '@teeps-co/teeps-auth-next';
 *
...
export default ({
  children,
  user: initialUser,
  profileUrl = process.env.NEXT_PUBLIC_TEEPS_AUTH_PROFILE || '/api/auth/me',
  loginUrl,
  fetcher = userFetcher
