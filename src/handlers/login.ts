...
import { AuthorizationParameters, HandleLogin as BaseHandleLogin } from '../teeps-auth-session';
 ...
 * import { handleAuth, handleLogin } from '@teeps-co/teeps-auth-next';
 *
...
export interface AuthorizationParams extends Partial<AuthorizationParameters> {
   ...
   * ```js
   * // pages/api/invite.js
   * import { handleLogin } from '@teeps-co/teeps-auth-next';
   *
  ...
  /**
   * Provides a hint to TeepsAuth as to what flow should be displayed. The default behavior is to show a
