...
import { AuthorizationParameters, HandleCallback as BaseHandleCallback } from '../teeps-auth-session';
 ...
 * import { handleAuth, handleCallback } from '@teeps-co/teeps-auth-next';
 *
